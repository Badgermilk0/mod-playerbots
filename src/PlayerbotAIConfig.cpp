...
bool PlayerbotAIConfig::Initialize()
{
    ...
    rtscInterruptInFlightMove = sConfigMgr->GetOption<bool>("AiPlayerbot.RTSCInterruptInFlightMove", true);
    rtscUnforcedGrace = sConfigMgr->GetOption<int32>("AiPlayerbot.RTSCUnforcedGrace", 1500);
